...
import com.anzelmas.lkl.adapters.RezultataiAdapter;

/**
 * A simple {@link Fragment} subclass.
 * Use the {@link RezultataiFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class RezultataiFragment extends Fragment {
    ...
    public static RezultataiFragment newInstance(String param1, String param2) {
        RezultataiFragment fragment = new RezultataiFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_rezultatai, container, false);
        ...
        s3 = getResources().getStringArray(R.array.rezultatas);

        // create an adapter
        RezultataiAdapter rezultataiAdapter = new RezultataiAdapter(s1, s2, s3, homeTeamImages, awayTeamImages);

        // set an adapter
        resultList.setAdapter(rezultataiAdapter);
